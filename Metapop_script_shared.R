...
# Call JAGS from R, using jagsUI syntax
starttime <- Sys.time()
m10 <- jags(jags.data, inits, parameters, "model10.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel=FALSE)
endtime <- Sys.time()
options(max.print=999999) #Default is 99999
print(m10, digits = 3) #2.1 h at 150 it/3 chains
print(m10$summary[1:400,], digits = 3) #phi for adults hasn't changed much, phi for first year-of-life more realistic (around 50%)
