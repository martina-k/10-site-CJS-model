...
#Model 12
########################
#Different variance for p depending on period
...
# Call JAGS from R, using jagsUI syntax
starttime <- Sys.time()
m12 <- jags(jags.data, inits, parameters, "model12.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel=FALSE)
endtime <- Sys.time()
options(max.print=999999) #Default is 99999
print(m12, digits = 3) # 
print(m12$summary[1:400,], digits = 3)
